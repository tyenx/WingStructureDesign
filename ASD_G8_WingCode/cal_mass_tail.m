function mass = cal_mass_tail(aerofoil_section_geometry, material_properties, stringer_design, spar_design, skin_thickness, rib_distance, D_section_thickness, rib_thickness, spar_thickness_front, spar_thickness_rear)
...
length_Dsection = 757.22e-3/2.36; % Perimeter of the D-section skin cross-section, unit (* chord length)
length_wingbox = 2598.75e-3/2.36; % Perimeter of the wing box skin cross-section, unit (* chord length)
length_trailingedge = 1425.89e-3/2.36; % Perimeter of the trailing edge skin cross-section, unit (* chord length)
area = 343532.13e-6/2.36^2; % Wing cross-sectional area, unit (* chord length^2)
